                        ...
                        onClick={async () => {
                          try {
                            ...
                            if (projectData.quote) {
                              console.log('Restoring saved quote:', projectData.quote);
                              console.log('Project total cost:', projectData.project?.total_cost);
                              
                              // Use the project's saved total cost, not the quote's potentially updated cost
                              const restoredQuote = {
                                ...projectData.quote,
                                total_cost: projectData.project?.total_cost || projectData.quote.total_cost,
                                original_total_cost: projectData.project?.total_cost || projectData.quote.total_cost
                              };
