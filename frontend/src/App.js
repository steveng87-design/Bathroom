  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        {/* BOTTOM ACTION BAR - Simplified and properly placed */}
        {quote && (
          <Card className="fixed bottom-4 left-4 right-4 z-50 shadow-2xl">
            <CardContent className="p-4">
              <div className="grid grid-cols-4 gap-3">
                <Button onClick={() => setPdfDialogOpen(true)} className="bg-blue-600 hover:bg-blue-700 text-white">
                  <FileText className="w-4 h-4 mr-1" />
                  PDF
                </Button>
                <Button onClick={saveCurrentProject} className="bg-orange-600 hover:bg-orange-700 text-white">
                  <Save className="w-4 h-4 mr-1" />
                  Save
                </Button>
                <Button onClick={() => setEmailDialogOpen(true)} className="bg-green-600 hover:bg-green-700 text-white">
                  <Mail className="w-4 h-4 mr-1" />
                  Email
                </Button>
                <Button onClick={() => { setQuote(null); toast.success('Ready for new quote!'); }} className="bg-purple-600 hover:bg-purple-700 text-white">
