              ...
              <form onSubmit={handleSubmit} className="space-y-10">
                ...
                <div className="bg-gradient-to-r from-gray-50 to-blue-50 p-8 rounded-2xl border border-blue-100">
                  ...
                  <div className="space-y-4">
                        ...
                        <>
                          <div className="flex items-center justify-center">
                            ...
                            <div className="flex flex-col">
                              ...
                              <span className="text-sm opacity-90">Standard AI Analysis</span>
                            </div>
                          </div>
                        </>
                      )}
                    ...
                    <Button 
                      type="button"
                      onClick={handleSubmitWithLearning}
                      className="w-full bg-gradient-to-r from-emerald-600 via-teal-600 to-cyan-600 hover:from-emerald-700 hover:via-teal-700 hover:to-cyan-700 text-white py-6 text-lg font-bold shadow-xl transform hover:scale-105 transition-all duration-300"
                      disabled={loading}
                    >
                      {loading ? (
                        <>
                        ...
                        <>
                          <div className="flex items-center justify-center">
                            ...
                            <div className="flex flex-col">
                              <span>Generate with AI Learning</span>
                              <span className="text-sm opacity-90">Personalized to your pricing</span>
                            </div>
                          </div>
                        </>
                      )}
