                ...
                {quote.areas_count > 1 && (
                  <Button
                    onClick={() => {
                      if (currentAreaView === 'combined') {
                        setCurrentAreaView(quote.area_quotes[0].area_name.toLowerCase().includes('main') ? 'main' : 'area1');
                      } else if (currentAreaView === 'main' || currentAreaView === 'area1') {
                  ...
                  >
                    ...
                    {currentAreaView === 'combined' ? 'View Main Bathroom' : 
                     currentAreaView === 'main' || currentAreaView === 'area1' ? 'View Separate WC' : 
                     'View Combined'}
                  </Button>
                )}
