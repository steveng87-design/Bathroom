          ...
          <CardContent className="p-6">
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="space-y-6 bg-gradient-to-br from-purple-50 to-pink-50 p-6 rounded-2xl border border-purple-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {/* TEMPORARILY COMMENTED OUT - CAUSES INFINITE LOOP */}
                  <div className="col-span-2 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                    ...
                    <p className="text-amber-700 text-sm">The detailed component selection interface has been temporarily disabled due to a technical issue. Use the simplified version below.</p>
                  </div>
                  {/* 
