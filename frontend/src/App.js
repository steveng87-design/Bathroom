                            ...
                            <div className="flex items-center space-x-2 p-1 rounded-lg hover:bg-blue-50 transition-colors">
                              <Checkbox
                                ...
                                onCheckedChange={(checked) => {
                                  console.log(`Component ${key} toggled:`, checked);
                                  handleComponentToggle(key, checked);
                                }}
                              ...
                              <Label 
                                ...
                                onClick={() => {
                                  const current = getCurrentArea()?.components[key]?.enabled || false;
                                  console.log(`Label clicked for ${key}, current state:`, current);
                                  handleComponentToggle(key, !current);
                                }}
                              >
                                {label}
                              </Label>
